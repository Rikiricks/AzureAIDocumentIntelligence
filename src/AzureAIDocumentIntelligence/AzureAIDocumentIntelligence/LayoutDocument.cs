...
namespace AzureAIDocumentIntelligence
{
    public class LayoutDocument
    {
        ...
        public LayoutDocument(string fileUrl)
        {
            _fileUrl = fileUrl;
        }
        ...
        {
            Operation<AnalyzeResult> operation = await client.AnalyzeDocumentAsync(WaitUntil.Completed, "prebuilt-layout", new Uri(_fileUrl));
